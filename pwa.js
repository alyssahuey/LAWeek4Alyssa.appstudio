...
const cacheName = 'LAWeek4Alyssa-2021-02-24 15:45:59.236444'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWeek4Alyssa'.length) === 'LAWeek4Alyssa') {
